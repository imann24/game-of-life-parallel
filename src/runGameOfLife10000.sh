#!/bin/bash
# runGameOfLife10000.sh
# Muriel Brunet, Isaiah Mann
# CSC 352, Spring 17
# Run for 10000 generations
# chmod a+x runGameOfLife10000.sh
# ./runGameOfLife10000.sh
# ./runGameOfLife10000.sh 2>&1 | grep "with\|real" > timing10000gen.data 
...
for i in 2 4 8 12 16 20 32 64 ; do # number of threads
	...
	echo "RUN" $j
	time java GameOfLifeApplication "dish.txt" $i 10000 false
    done
done